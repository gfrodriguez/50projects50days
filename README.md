...
| 27| Notificación Toast| Mensaje emergente temporal que aparece en la interfaz para mostrar información al usuario.| CSS (animaciones), JavaScript (setTimeout), Accesibilidad (ARIA)| [Enlace](https://gfrodriguez.github.io/50projects50days/toast-notification/)|
