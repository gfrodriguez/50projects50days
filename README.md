...
| 21| Arrastrar y Soltar| Interfaz interactiva que permite mover elementos entre contenedores mediante arrastre con el ratón o toques en pantalla.| HTML5 Drag and Drop API, JavaScript (eventos drag), CSS (feedback visual)| [Enlace](https://gfrodriguez.github.io/50projects50days/drag-and-drop/)|
